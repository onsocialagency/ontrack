...
export function getIrgHeadlineKpis(brand: "all" | IrgBrandId = "all"): IrgHeadlineKpis {
  ...
  const perBrand: Record<IrgBrandId, IrgHeadlineKpis> = {
    ...
    IR_EVENTS: {
      totalSpend: 12_400,
      totalSpendDeltaPct: -2,
      eventsRevenue: 108_000,
      eventsRevenueDeltaPct: 22,
      hotelRevenue: 0,
      hotelRevenueDeltaPct: 0,
      totalRevenue: 108_000,
      overallRoas: 8.7,
      overallRoasDelta: 1.1,
      ticketsSold: 412,
      ticketsDelta: 31,
      cpa: 30.10,
      cpaDelta: -1.85,
    ...
    POOL_CLUB: {
      totalSpend: 2_100,
      totalSpendDeltaPct: 6,
      eventsRevenue: 22_800,
      eventsRevenueDeltaPct: 9,
      hotelRevenue: 0,
      hotelRevenueDeltaPct: 0,
      totalRevenue: 22_800,
      overallRoas: 10.9,
      overallRoasDelta: 0.8,
      ticketsSold: 142,
      ticketsDelta: 18,
      cpa: 14.78,
      cpaDelta: -1.20,
